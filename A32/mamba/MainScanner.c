...
/* External objects */
extern mamba_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
mamba_void printScannerError(mamba_char* fmt, ...);
mamba_void displayScanner(BufferReader* ptrBuffer);
mamba_long getScannerFilesize(mamba_char* fname);
